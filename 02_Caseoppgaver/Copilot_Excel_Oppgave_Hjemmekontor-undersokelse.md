...
[`Hjemmekontor_undersokelse_2026.xlsx`](https://github.com/gdd2s/Tekna-KI-PL-kurs-042026/blob/main/02_Caseoppgaver/Hjemmekontor_undersokelse_2026.xlsx) — 84 respondenter, 10 spørsmål av blandet type (single-choice, Likert-skala 1–5, multi-select, fritekst), pluss demografiske felt (avdeling, ansiennitet, rolle, aldersgruppe).

## Forutsetninger

- Du har Microsoft 365 med Copilot-lisens aktivert
- Last ned vedlegget fra lenken over til din egen maskin
- Åpne web-versjonen av Excel på [https://excel.cloud.microsoft/](https://excel.cloud.microsoft/)
- Klikk på **«Last opp en fil»** i Excel-grensesnittet, og velg den nedlastede filen
